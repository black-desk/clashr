...
#
# Build:
#   - git clone -b dev https://github.com/black-desk/clashr
#   - cd clashr
...
go build -ldflags "-X \"github.com/black-desk/clashr/constant.Version=$VERSION\" -X \"github.com/black-desk/clashr/constant.BuildTime=$BUILDTIME\" -w -s" \
